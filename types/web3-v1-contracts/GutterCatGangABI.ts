...
export interface GutterCatGangABI extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): GutterCatGangABI;
  clone(): GutterCatGangABI;
  methods: {
    _baseURI(): NonPayableTransactionObject<string>;

    _contractURI(): NonPayableTransactionObject<string>;

    _tokenURIs(arg0: number | string | BN): NonPayableTransactionObject<string>;

    adoptCat(): PayableTransactionObject<void>;

    adoptCats(_howMany: number | string | BN): PayableTransactionObject<void>;

    adoptedCats(): NonPayableTransactionObject<string>;
    ...
    getItemPrice(): NonPayableTransactionObject<string>;
    ...
    itemPrice(): NonPayableTransactionObject<string>;
    ...
    reclaimToken(token: string): NonPayableTransactionObject<void>;
